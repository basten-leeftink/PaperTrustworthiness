package asl
         ...
         message match {
            case SubGoalMessage(_,_,r) =>
               message.goal match {
                   ...
                   case tom.this.adopt_achievement_competent_3 =>
                     tom.this.adopt_achievement_competent_3.execute(message.params.asInstanceOf[Parameters])

                   case tom.this.adopt_achievement_comp_conditions_3 =>
                     tom.this.adopt_achievement_comp_conditions_3.execute(message.params.asInstanceOf[Parameters])

                   case tom.this.adopt_achievement_comp_subplans_2 =>
                     tom.this.adopt_achievement_comp_subplans_2.execute(message.params.asInstanceOf[Parameters])

                   case tom.this.adopt_achievement_comp_total_2 =>
                     tom.this.adopt_achievement_comp_total_2.execute(message.params.asInstanceOf[Parameters])
 ...
 class Agent extends IAgent {
         ...
         def initGoals()(implicit executionContext: ExecutionContext) = List[StructTerm](
                     StructTerm("competent",Seq[GenericTerm]( StructTerm("agentT",Seq[GenericTerm]()) , StructTerm("tom",Seq[GenericTerm]()) , StructTerm("report",Seq[GenericTerm]())  ))
         ...
         def initBeliefs()(implicit executionContext: ExecutionContext) = List[StructTerm](
           ...
           ,
            StructTerm("knowledge",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("research",Seq[GenericTerm]()),DoubleTerm(0.6)))
           ,
            StructTerm("knowledge",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("writing",Seq[GenericTerm]()),DoubleTerm(0.6)))
           ,
            StructTerm("skill",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("research",Seq[GenericTerm]()),DoubleTerm(0.8)))
           ,
            StructTerm("skill",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("writing",Seq[GenericTerm]()),DoubleTerm(0.5)))
           ,
            StructTerm("resource",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("research",Seq[GenericTerm]()),IntTerm(0)))
           ,
            StructTerm("resource",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),StructTerm("writing",Seq[GenericTerm]()),IntTerm(1)))
           ,
        ...
        def execute(params: Parameters) (implicit executionContext: ExecutionContext) : Unit = {
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
                 ...
                 //plan 0 start
                         ...
                         val m0 = executionContext.beliefBase.matchTerms(StructTerm("competent",Seq[GenericTerm](vars("AgentT"),StructTerm("tom",Seq[GenericTerm]()),vars("Goal"))),StructTerm("competent",params.l_params));
                         if(m0.result)
                         {
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( (StringTerm("The goal ") + vars("Goal"))  + StringTerm(" consists of the subplans: ")) )))
                                               val ex_L17247 = executionContext.beliefBase.bufferedQuery( StructTerm("subplan",Seq[GenericTerm](vars("Goal"),vars("L17247"))) )
                                               while (ex_L17247.hasNext) {
                                                   val sol_L17247 = ex_L17247.next
                                                   if(sol_L17247.result) {
                                                   vars += ("Subplan" -> sol_L17247.bindings("L17247").asInstanceOf[GenericTerm])
                                                                       PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( (StringTerm("- ") + vars("Subplan")) )))

                                                   }
                                               }
                                           vars -= ("Subplan")
                                               val ex_L27378 = executionContext.beliefBase.bufferedQuery( StructTerm("subplan",Seq[GenericTerm](vars("Goal"),vars("L27378"))) )
                                               while (ex_L27378.hasNext) {
                                                   val sol_L27378 = ex_L27378.next
                                                   if(sol_L27378.result) {
                                                   vars += ("Subplan" -> sol_L27378.bindings("L27378").asInstanceOf[GenericTerm])
                                           ...
                                           vars -= ("Subplan")
                                          adopt_achievement_comp_total_2.execute(Parameters(List( StructTerm("tom",Seq[GenericTerm]()) , vars("Goal")  )))
        ...
        def execute(params: Parameters) (implicit executionContext: ExecutionContext) : Unit = {
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
                 ...
                 //plan 0 start
                         ...
                         val m0 = executionContext.beliefBase.matchTerms(StructTerm("comp_conditions",Seq[GenericTerm](vars("AgentT"),StructTerm("tom",Seq[GenericTerm]()),vars("Subplan"))),StructTerm("comp_conditions",params.l_params));
                         if(m0.result)
                         {
                          m0.bindings foreach { case (k, v) =>
                          //vars += (k -> v.asInstanceOf[GenericTerm])
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          if(( ( ( (vars("K") >= vars("TK"))  &&  (vars("S") >= vars("TS")) )  &&  (vars("R") == IntTerm(1)) ) ).holds) {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( ( (StringTerm("- ") + StructTerm("tom",Seq[GenericTerm]()))  + StringTerm(" is competent for the subplan: "))  + vars("Subplan")) )))
                                                                  ...
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( ( (StringTerm("- ") + StructTerm("tom",Seq[GenericTerm]()))  + StringTerm(" is incompetent for the subplan: "))  + vars("Subplan")) )))
                                          ...
                                          if(( (vars("K") < vars("TK")) ).holds) {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( ( ( ( (StringTerm("-> ") + StructTerm("tom",Seq[GenericTerm]()))  + StringTerm(" misses "))  +  (vars("TK") - vars("K")) )  + StringTerm(" knowledge for the subplan: "))  + vars("Subplan")) )))

                                          }
                                          if(( (vars("S") < vars("TS")) ).holds) {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( ( ( ( (StringTerm("-> ") + StructTerm("tom",Seq[GenericTerm]()))  + StringTerm(" misses "))  +  (vars("TS") - vars("S")) )  + StringTerm(" skills for the subplan: "))  + vars("Subplan")) )))

                                          }
                                          if(( (vars("R") == IntTerm(0)) ).holds) {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( ( (StringTerm("-> ") + StructTerm("tom",Seq[GenericTerm]()))  + StringTerm(" misses the resources for the subplan: "))  + vars("Subplan")) )))
        ...
        def execute(params: Parameters) (implicit executionContext: ExecutionContext) : Unit = {
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
                 ...
                 //plan 0 start
                         ...
                         val m0 = executionContext.beliefBase.matchTerms(StructTerm("comp_total",Seq[GenericTerm](StructTerm("tom",Seq[GenericTerm]()),vars("Goal"))),StructTerm("comp_total",params.l_params));
                         if(m0.result)
                         {
                          m0.bindings foreach { case (k, v) =>
                          //vars += (k -> v.asInstanceOf[GenericTerm])
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          if(( (vars("NS") == vars("SS")) ).holds) {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( (StructTerm("tom",Seq[GenericTerm]()) + StringTerm(" is competent for the goal: "))  + vars("Goal")) )))

                                          }
                                           else {
                                                                  PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( ( (StructTerm("tom",Seq[GenericTerm]()) + StringTerm(" is incompetent for the goal: "))  + vars("Goal")) )))
